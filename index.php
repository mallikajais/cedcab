                ...
                <div >
                    <form method="post">
                        ...
                        <select class="form-control" id="cabtype" onchange="luggage()">
                            <option value="" selected disabled>Select cabtype</option>
                            ...
                            <div class="modal-dialog ">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success" data-dismiss="modal" onClick="window.location.reload()">  Back  </button>
